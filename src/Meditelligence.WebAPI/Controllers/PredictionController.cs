...
namespace Meditelligence.WebAPI.Controllers
{
    ...
    public class PredictionController : Controller
    {
        ...
        /// <returns>An <see cref="IActionResult"/> containing status code and message content.</returns>
        ...
        public IActionResult PredictiveDiagnosis([FromForm]List<string> symptoms)
        {
